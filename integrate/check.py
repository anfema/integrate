...
class Check(object):
	...
	def log_error(self, error, message, strip=4):
	...
	def raises(self, exception_type, function, *args, **kwargs):
		...
		try:
			...
			self.log_error("{} did not throw exception {}".format(function.__name__, exception_type.__name__), None)
			return result
		except Exception as e:
			if type(e) != exception_type:
				self.log_error("{} did raise {}: {}".format(function.__name__, type(e).__name__, e), None)
